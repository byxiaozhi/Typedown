...
namespace Typedown.Core.Utilities
{
    public static class Locale
    {
        ...
        {
            {ResourceSource.CommonResources,  ResourceLoader.GetForViewIndependentUse("Typedown.Core/" + nameof(ResourceSource.CommonResources))},
            {ResourceSource.DialogResources,  ResourceLoader.GetForViewIndependentUse("Typedown.Core/" + nameof(ResourceSource.DialogResources))},
            {ResourceSource.SettingsResources,  ResourceLoader.GetForViewIndependentUse("Typedown.Core/" + nameof(ResourceSource.SettingsResources))},
            {ResourceSource.Resources,  ResourceLoader.GetForViewIndependentUse("Typedown.Core/" + nameof(ResourceSource.Resources))}
        };
