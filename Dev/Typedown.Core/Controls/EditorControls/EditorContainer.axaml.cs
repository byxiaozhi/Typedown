...
namespace Typedown.Core.Controls
{
    ...
    {
        private readonly static StyledProperty IsFindReplaceLoadProperty = AvaloniaProperty.Register<EditorContainer, bool>(nameof(IsFindReplaceLoad), new(false));
        private bool IsFindReplaceLoad { get => GetValue(IsFindReplaceLoadProperty); set => SetValue(IsFindReplaceLoadProperty, value); }

        private readonly static StyledProperty FindReplaceCenterPointProperty = AvaloniaProperty.Register<EditorContainer, Point>(nameof(FindReplaceCenterPoint), new(new Point()));
        ...
        private readonly static StyledProperty ScrollStateProperty = AvaloniaProperty.Register<EditorContainer, ScrollState>(nameof(ScrollState), new(new ScrollState(), (d, e) => (d as EditorContainer).OnStyledPropertyChanged(e)));
