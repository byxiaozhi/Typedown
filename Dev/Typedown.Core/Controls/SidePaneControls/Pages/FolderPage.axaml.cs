...
namespace Typedown.Core.Controls.SidePanelControls.Pages
{
    public sealed partial class FolderPage : Page, INotifyPropertyChanged
    {
        ...
        private static void OnTreeViewItemPointerPressed(object sender, Windows.UI.Xaml.Input.PointerEventArgs e)
        {
        ...
        private async void OnTreeViewItemPointerReleased(object sender, Windows.UI.Xaml.Input.PointerEventArgs e)
        {
            try
            {
